...
实验将扩展到主表全部10个数据集，使用可配置的 LLM-as-a-Judge，并在每个
...
- `visualize/plot_confidence_calibration.py`
- `pics/figure5_confidence_distribution_0713.png`
- `pics/figure5_confidence_distribution_0713.pdf`
- `pics/figure5_accuracy_confidence_gap_0713.png`
- `pics/figure5_accuracy_confidence_gap_0713.pdf`
- `pics/figure5_reliability_0713.png`
- `pics/figure5_reliability_0713.pdf`
- `result_figure5_llm_judge/figure5_metrics_0713.csv`
...
3. Figure 5：在全部10个数据集上调用 LLM Judge 标注 feedback，计算校准指标。
